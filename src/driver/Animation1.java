...
public class Animation1 extends JLabel implements TReceiver, ActionListener {
	...
	public Animation1(Transducer transducer) {
		...
		for (int i = 1; i <= MAX_STAGE; i++) {
			String path = "imageicons" + File.separator + "anim1_" + i + ".png";
	...
	public void eventFired(TChannel channel, TEvent event, Object[] args) {
		// System.out.println("---Animation1 received event fired");
		if (event == TEvent.START_ANIMATION1) {
			System.out.println("Animation1: Starting Animation");
			this.startAnimation();
		}
	}
	...
	public void actionPerformed(ActionEvent ae) {
		if (animationInProgress) {
			...
			if (stage <= MAX_STAGE) {
				...
				myTransducer.fireEvent(TChannel.GUI, TEvent.ANIMATION1_FINISHED, args);
			}
		}
	}
}
